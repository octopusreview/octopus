...
NEXT_PUBLIC_GITHUB_APP_SLUG=<the slug from the App's URL>`}</CodeBlock>
      ...
      <Section title="Troubleshooting">
        ...
        <UL>
          ...
          <li>
            <Mono>/settings/audit-log</Mono> shows the review job being picked
            up. If not, the worker isn&apos;t enabled — set{" "}
            <Mono>ENABLE_REVIEW_WORKERS=true</Mono>.
          </li>
        </UL>
      ...
      <Section title="Related">
        <P>
          For OAuth login (separate from the GitHub App used for repos), see{" "}
