 ...
 *
 * Match strategy: normalise the input into a `provider/owner/repo` triple
 * and compare against Repository.fullName. We deliberately ignore the URL
 * host / SSH-vs-HTTPS variation so the same physical repo cloned via
 * different protocols resolves to the same Octopus row.
 */
