 ...
 *
 * The repo hosts two release trains: web `v*` (release.yml) and CLI
 * `octp-v*` (octp-release.yml). The shipped /releases/latest can return
 * either, which is the H11 bug in the pre-upstream audit — admins saw
 * "0.5.0 → octp-v0.2.0" upgrade panels every time the CLI shipped.
 */
