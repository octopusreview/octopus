...
const publicPrefixes = ["/login", "/blocked", "/docs", "/api/auth", "/api/github", "/api/bitbucket/webhook", "/api/pubby", "/api/version", "/api/invitations", "/api/slack/commands", "/api/stripe", "/api/cli"];
const publicExact = ["/"];
